  ...
  return (
    <Carousel
      ...
      renderIndicator={(clickHandler, isSelected) => {
        return (
          <li className={`carousel-indicator ${isSelected ? `selected` : ''}`} onClick={clickHandler}></li>
        );
      }}
    ...
    >
      ...
      <div className="carousel-img">
        <img src="//unsplash.it/1521/360" />
      </div>
      <div className="carousel-img">
        <img src="//unsplash.it/1519/360" />
      </div>
      <div className="carousel-img">
        <img src="//unsplash.it/1518/360" />
      </div>
      <div className="carousel-img">
        <img src="//unsplash.it/1522/360" />
      </div>
    </Carousel>
  );
}
